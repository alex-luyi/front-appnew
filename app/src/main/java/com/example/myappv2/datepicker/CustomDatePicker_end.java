package com.example.myappv2.datepicker;
...
public class CustomDatePicker_end implements View.OnClickListener, PickerView_end.OnSelectListener {
    ...
    private PickerView_end mDpvYear, mDpvMonth, mDpvDay, mDpvHour, mDpvMinute;
    ...
    public CustomDatePicker_end(Context context, Callback callback, String beginDateStr, String endDateStr) {
     ...
     */
    public CustomDatePicker_end(Context context, Callback callback, long beginTimestamp, long endTimestamp) {
    ...
    private void initView() {
        ...
        mPickerDialog.setContentView(R.layout.dialog_date_picker_end);
        ...
        mPickerDialog.findViewById(R.id.tv_cancel_end).setOnClickListener(this);
        mPickerDialog.findViewById(R.id.tv_confirm_end).setOnClickListener(this);
        mTvHourUnit = mPickerDialog.findViewById(R.id.tv_hour_unit_end);
        mTvMinuteUnit = mPickerDialog.findViewById(R.id.tv_minute_unit_end);

        mDpvYear = mPickerDialog.findViewById(R.id.dpv_year_end);
        mDpvYear.setOnSelectListener(this);
        mDpvMonth = mPickerDialog.findViewById(R.id.dpv_month_end);
        mDpvMonth.setOnSelectListener(this);
        mDpvDay = mPickerDialog.findViewById(R.id.dpv_day_end);
        mDpvDay.setOnSelectListener(this);
        mDpvHour = mPickerDialog.findViewById(R.id.dpv_hour_end);
        mDpvHour.setOnSelectListener(this);
        mDpvMinute = mPickerDialog.findViewById(R.id.dpv_minute_end);
