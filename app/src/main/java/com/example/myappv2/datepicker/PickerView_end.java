 ...
 * 说明：内容选择器，例如年月日、省市区等
 */
public class PickerView_end extends View {
    ...
    private static class ScrollHandler extends Handler {
        private WeakReference<PickerView_end> mWeakView;

        private ScrollHandler(PickerView_end view) {
            mWeakView = new WeakReference<>(view);
        }

        @Override
        public void handleMessage(Message msg) {
            PickerView_end view = mWeakView.get();
            if (view == null) return;
    ...
    public PickerView_end(Context context, AttributeSet attrs) {
        super(context, attrs);
